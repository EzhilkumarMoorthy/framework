...
trait MongoMeta[BaseDocument, TDocument] extends JsonFormats with MongoCodecs {
  ...
  @deprecated("Use useCollection instead", "3.4.0")
  ...
  @deprecated("Use useDatabase instead", "3.4.0")
   ...
   */
  @deprecated("Use deleteOne or deleteMany instead", "3.4.0")
  ...
  @deprecated("Use createIndex that takes IndexOptions as argument instead", "3.4.0")
  ...
  @deprecated("Use updateOne or updateMany instead", "3.4.0")
...
*/
@deprecated("Use com.mongodb.client.model.UpdateOptions instead", "3.4.0")
